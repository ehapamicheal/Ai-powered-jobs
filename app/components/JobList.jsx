...
//                     {jobs.map((job) => (
//                         <div key={job.id} className="jobs_card p-4 border rounded-lg shadow-lg hover:border-yellow transition-all duration-300 ease-in-out transform hover:shadow-xl hover:scale-104">
...
//                                     <span className={`px-2 py-1 text-white text-sm rounded ${getScoreColor(job.matchScore)}`}>{job.matchScore}% Match</span>
//                                     <p>match</p>
//                                 </div>
...
//     const userSkills = ["React", "JavaScript", "CSS", "Node.js", "MongoDB"]; 
...
//                                 <div className="flex items-center gap-2">
//                                     <span className={`px-2 py-1 text-white text-sm rounded ${getScoreColor(job.matchScore)}`}>
