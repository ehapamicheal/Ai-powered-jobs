...
const Header = ({ children, onToggleSidebar }) => {
  ...
  return (
    // <header className="header_container bg-white shadow-md fixed top-0 h-14 left-64 w-[calc(100%-16rem)] px-3 py-3 z-10">
...
//                 <RxHamburgerMenu className="open_menu"  onClick={toggleSidebar} />
//               </div>
...
//           <div className="flex items-center gap-1 border border-gray-1 p-1 rounded-full">
//             <BiSearch className="search_icon" />
//             <input className="outline-none border-none text-base text-black-1 leading-2 placeholder-gray-4" type="text" placeholder="Search Users" />  
//           </div>
